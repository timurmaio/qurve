...
const COMPONENTS: Item[] = [
  ...
  { component: "ComposedChart", recharts: "ComposedChart", qurve: "ComposedChart", status: "done", notes: "Alias of Chart; mix Line, Bar, Area, Scatter" },
  { component: "PieChart", recharts: "PieChart", qurve: "PieChart", status: "done", notes: "Compose Pie, Tooltip, Legend; optional Cell" },
  { component: "ScatterChart", recharts: "ScatterChart", qurve: "ScatterChart", status: "done", notes: "Compose Scatter, XAxis, YAxis, ZAxis" },
  ...
  { component: "Label", recharts: "Label", qurve: "Label", status: "done", notes: "Chart-level title/caption; Pie keeps its own label prop" },
  { component: "LabelList", recharts: "LabelList", qurve: "LabelList", status: "done", notes: "Sibling of series; shape=point|bar, formatter, valueKey" },
  ...
  { component: "ZAxis", recharts: "ZAxis", qurve: "ZAxis", status: "done", notes: "Bubble size scale; use with Scatter zKey" },
